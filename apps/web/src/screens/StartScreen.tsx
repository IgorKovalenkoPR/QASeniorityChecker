      ...
      <div className="stack" style={{ gap: 'var(--sp-5)' }}>
        ...
        <Card>
          ...
          <ul className="small muted" style={{ marginTop: 'var(--sp-4)', paddingLeft: 'var(--sp-5)' }}>
            ...
            <li>
              Кожна відповідь надсилається на сервер одразу після вибору. Якщо звʼязок зникне саме
              в цей момент, остання відповідь може не зберегтися - тоді просто виберіть її ще раз.
            </li>
          </ul>
        </Card>
      </div>
